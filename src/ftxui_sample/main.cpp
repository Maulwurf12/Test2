...
// configuration step. It creates a namespace called `Test2`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", Test2::cmake::project_name, Test2::cmake::project_version) };
